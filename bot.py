...
async def info(ctx):
    ...
    embed.add_field(name="Library", value="discord.py 2.x", inline=False)
...
async def help(ctx):
    ...
    embed.add_field(name="!uptime", value="Bot status", inline=False)
    ...
    embed.add_field(name="!ask", value="Ask AI", inline=False)
